...
// ListRepositoryTree provides a mock function with given fields: projectID
func (_m *GitClientMock) ListRepositoryTree(projectID interface{}) ([]git.TreeNode, error) {
	...
	var r0 []git.TreeNode
	var r1 error
	if rf, ok := ret.Get(0).(func(interface{}) ([]git.TreeNode, error)); ok {
		return rf(projectID)
	}
	if rf, ok := ret.Get(0).(func(interface{}) []git.TreeNode); ok {
		r0 = rf(projectID)
	} else {
		if ret.Get(0) != nil {
...
//   - projectID interface{}
func (_e *GitClientMock_Expecter) ListRepositoryTree(projectID interface{}) *GitClientMock_ListRepositoryTree_Call {
	return &GitClientMock_ListRepositoryTree_Call{Call: _e.mock.On("ListRepositoryTree", projectID)}
}

func (_c *GitClientMock_ListRepositoryTree_Call) Run(run func(projectID interface{})) *GitClientMock_ListRepositoryTree_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *GitClientMock_ListRepositoryTree_Call) RunAndReturn(run func(interface{}) ([]git.TreeNode, error)) *GitClientMock_ListRepositoryTree_Call {
	_c.Call.Return(run)
	return _c
}
